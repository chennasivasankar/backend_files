...
def total_number_of_rating_of_movie(movie_rating_obj):
    try:
...
def get_average_rating_of_movie(movie_rating):
    try:
...
#         movie_ids.append(movie_obj.movie_id)
...
#         cast_list=[]
#         for cast_item in mov.cast_set.all():
#             if(cast_item.actor.gender=='MALE' and female==1):
#                 continue
#             actor_info={
#                 'name':cast_item.actor,
#                 'actor_id':cast_item.actor_id
#             }
#             cast_info={
#                 "actor":actor_info,
#                 "role":cast_item.role,
#                 "is_debut_movie":cast_item.role
#             }
...
#                 "name":mov.name,
#                 "cast":cast_list,
#                 "box_office_collection_in_crores":mov.box_office_collection_in_crores,
#                 "release_date":str(mov.release_date),
#                 "director_name":mov.director.name,
#                 "average_rating":get_average_rating_of_movie(mov.rating),
#                 "total_number_of_ratings":total_number_of_rating_of_movie(mov.rating)
#             }
#         except:
#             mov_info={
#                 "movie_id":mov.movie_id,
...
#             }
#         movies_info_details.append(mov_info)
#     return(movies_info_details)
    ...
    for actor_obj in actor_objs:
        ...
        for actor_mov in actor_obj.movie_set.all():
            ...
            actor_mov_detail={
                ...
                "average_rating":get_average_rating_of_movie(actor_mov.rating),
                "total_number_of_ratings":total_number_of_rating_of_movie(actor_mov.rating)
            }
...
def get_female_cast_details_from_movies_having_more_than_five_female_cast():
    ...
    return get_movies_by_given_movie_objs(movie_objs,female=1)
...
#Trail-Task-4
def get_movies_by_given_movie_names(movie_names):
    all_movies = Movie.objects.filter(name__in = movie_names)
    return returning_movie_json1(all_movies)    
    
def returning_movie_json1(movies_list):
    all_movies = movies_list.values('movie_id','name','release_date','box_office_collection_in_crores','director__name','actors__name','actors__actor_id','actors__gender','cast__role','cast__is_debut_movie','rating__rating_one_count','rating__rating_two_count','rating__rating_three_count','rating__rating_four_count','rating__rating_five_count')
    movies_dict = {}
